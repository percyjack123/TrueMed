        ...
        <div className="w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="rounded-2xl border border-slate-800 bg-black/40 backdrop-blur-xl p-8 shadow-xl">
              ...
              <label
  htmlFor="upload"
  className={`flex flex-col items-center justify-center rounded-xl border border-dashed border-sky-400/40 px-6 cursor-pointer transition hover:border-sky-400 hover:cursor-pointer hover:bg-sky-400/5 ${image ? "py-4" : "py-12"}`}
>
  ...
  <>
    ...
    <p className="mt-2 text-xs text-slate-400 truncate text-center">
      {image.name}
    </p>
  </>
)}
              ...
              <button
                ...
                className="mt-8 w-full rounded-xl bg-sky-400 py-4 text-lg hover:cursor-pointerfont-semibold text-[#020617]
